...
USAGE:
    ./scripts/theme-switcher.sh [OPTIONS] [THEME]
...
EXAMPLES:
    ./scripts/theme-switcher.sh                    # Interactive selection with FZF
    ./scripts/theme-switcher.sh nord              # Apply Nord theme
    ./scripts/theme-switcher.sh --preview tokyo-night  # Preview without applying
    ./scripts/theme-switcher.sh --list            # List all available themes
